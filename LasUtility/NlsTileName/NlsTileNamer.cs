...
namespace LasUtility.NlsTileName
{
    public class NlsTileNamer
    {
        ...
        //    double dsubs = Math.Round((max - min) / edge, 0);

        //    int subs = (int)Math.Round((max - min) / edge, 0);

        //    Console.WriteLine("parts as double {0}, parts as int {1}", dsubs, subs);
        ...
        //    Console.WriteLine("ix = " + x);





        //    string name = Encode(426502, 7214414, 1000);
        //    Debug.Assert(name == "R4412H3_6");
        ...
        //{
        //    name = Encode(426502, 7214414, 3000);
        //    Debug.Assert(name == "R4412H3");
        //    //Console.WriteLine(name);

        //    name = Encode(426502, 7214414, 12000);
        //    Debug.Assert(name == "R4412R");
        //    //Console.WriteLine(name);
        //}

        //sw.Stop();
        //Console.WriteLine("2 million formations took {0} seconds", sw.Elapsed.TotalSeconds);

        //int iMinEast = 0, iMinNorth = 0, iMaxEast = 0, iMaxNorth = 0;

        //sw.Restart();
        //for (int i = 0; i < 1000000; i++)
        //{
        //    string sTileName = "V5211G2_1";
        //    Decode(sTileName, out iMinEast, out iMinNorth, out iMaxEast, out iMaxNorth);
        //    Debug.Assert(iMinEast == 518000 && iMinNorth == 7581000 && iMaxEast == 519000 && iMaxNorth == 7582000);

        //    sTileName = "V4323L";
        //    Decode(sTileName, out iMinEast, out iMinNorth, out iMaxEast, out iMaxNorth);
        //    Debug.Assert(iMinEast == 428000 && iMinNorth == 7554000 && iMaxEast == 440000 && iMaxNorth == 7566000);
        //}

        //sw.Stop();
        //Console.WriteLine("2 million parses took {0} seconds", sw.Elapsed.TotalSeconds);

        //Console.WriteLine("MinEast {0}, MinNorth {1}, MaxEast {2}, MaxNorth {3}", iMinEast, iMinNorth, iMaxEast, iMaxNorth);
        //}
